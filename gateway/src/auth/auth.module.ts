...
export const VIP_NODE_PERMISSIONS: Record<string, string[]> = {
  ...
  pro: ['start', 'end', 'llm', 'text', 'image', 'video', 'variable', 'condition', 'multi-condition', 'http', 'code', 'loop', 'knowledge', 'subworkflow'],
  enterprise: ['start', 'end', 'llm', 'text', 'image', 'video', 'variable', 'condition', 'multi-condition', 'http', 'code', 'loop', 'knowledge', 'subworkflow'],
};
